...
class ThinkingConfig:
    ...
    def to_openai_reasoning(self) -> Reasoning:
        ...
        if self.reasoning_effort:
            ...
            effort_mapping: Dict[str, Optional[ReasoningEffort]] = {
        ...
        if self.reasoning_summary:
            summary_mapping: Dict[str, Optional[Literal["auto", "concise", "detailed", "always"]]] = {
                "concise": "concise",
                "detailed": "detailed",
                "never": None,  # Don't include summary field when "never"
                "auto": "auto",
                "always": "always",
            }
            
            summary: Optional[Literal["auto", "concise", "detailed", "always"]] = summary_mapping.get(self.reasoning_summary)
    ...
    def to_google_thinking_3(self, model_name: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def to_anthropic_adaptive_thinking(
        ...
        if self.reasoning_effort is not None:
            effort_mapping: Dict[str, Optional[str]] = {
    ...
    def to_cerebras_reasoning(self) -> Optional[str]:
        """
