...
from client.translators import CerebrasTranslator
...
class CerebrasChat:
    ...
    async def _execute_non_streaming(
        ...
        vcprint(f"[Cerebras] Conversion complete. {len(converted_response.messages)} messages", color="cyan")
    ...
    async def _execute_streaming(
        ...
        vcprint("[Cerebras] Stream connection established, processing chunks...", color="cyan")
        ...
        vcprint("[Cerebras] Stream accumulated, converting through translator...", color="cyan")
