...
from client.translators import OpenAITranslator
...
class OpenAIChat:
    ...
    async def execute(
        ...
        try:
            ...
            from client.errors import classify_openai_error
    ...
    async def _handle_event(self, event: Any, emitter: Emitter):
        ...
        # Reasoning streaming events
            ...
            if reasoning_id in self._reasoning_started:
                ...
                if self.debug:
                    vcprint(f"Reasoning completed with content: {reasoning_id}", color="blue")
            elif self.debug:
        ...
        # Stream lifecycle events
            ...
            if self.debug:
                ...
                vcprint(self._event_samples, "Unique Event Types & Samples", color="magenta", verbose=False)
                self._event_samples = {}
    ...
    async def _debug_event(self, event: Any):
        ...
        if event_type == "response.output_text.delta":
            ...
            vcprint("=================== RESPONSE COMPLETED ===================", color="green")
        else:
