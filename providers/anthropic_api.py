...
from client.translators import AnthropicTranslator
...
class AnthropicChat:
    ...
    def to_unified_response(
        ...
        return self.translator.from_anthropic(response_dict)
    ...
    async def execute(
        ...
        try:
            ...
            from client.errors import classify_anthropic_error
    ...
    async def _execute_streaming(
        ...
        # Convert to unified format
        converted_response = self.to_unified_response(final_message, model)
