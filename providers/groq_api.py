...
from client.translators import GroqTranslator
...
class GroqChat:
    ...
    async def _execute_non_streaming(
        ...
        vcprint(f"[Groq] Conversion complete. {len(converted_response.messages)} messages", color="cyan")
    ...
    async def _execute_streaming(
        ...
        vcprint("[Groq] Stream connection established, processing chunks...", color="cyan")
