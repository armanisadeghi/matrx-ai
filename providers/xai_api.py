...
from client.translators import XAITranslator
...
class XAIChat:
    ...
    async def _execute_non_streaming(
        ...
        vcprint(f"[xAI] Conversion complete. {len(converted_response.messages)} messages", color="cyan")
    ...
    async def _execute_streaming(
        ...
        vcprint("[xAI] Stream connection established, processing chunks...", color="cyan")
