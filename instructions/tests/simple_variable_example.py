...
variable_config = {
    "user_name": {"table": "USERS", "column": "ID", "value": "123", "fields": "name"},
    "user_role": {"table": "USERS", "column": "ID", "value": "123", "fields": "role"},
    "user_email": {"table": "USERS", "column": "ID", "value": "123", "fields": "email"},
